...
const headshots = [
  "url('images/photos/me2.jpeg')",
  "url('images/photos/me3.jpeg')",
  "url('images/photos/me1.jpeg')",
];
let headshotIndex = 0;
...
function autoChange() {
  ...
  document.getElementById("headshot").style.backgroundImage =
    headshots[headshotIndex];
}
...
function loadComments() {
  ...
  fetch(`/data?quantity=${commentCount}`)
